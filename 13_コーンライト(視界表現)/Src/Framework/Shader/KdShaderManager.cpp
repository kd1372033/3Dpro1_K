...
void KdShaderManager::WriteCBConeLight(const Math::Vector3& pos, const Math::Vector3& dir, float angle, float range, const Math::Vector3& col)
{
	//メンバー変数に値を代入
	...
	m_cb9_Light.Work().ConeLight.color = col;
	m_cb9_Light.Write();
}
